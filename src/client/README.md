...
2. - client_comm - implements list_clients, pull_messages, get_pubkey and send_message abilites for a user.
3. - client_crypto - handles decryption of messages, symmetric keys logic (request and send)
4. - client_init - basic client functions, working with me.info, registering

4. Base64Wrapper, AESWrapper, RSAWrapper - wrappers for AES, Base64, RSA (they are mostly completely from the course website and untouched)

4. tcp_client.cpp/.h - implementation of the lower level TCPClient for receiving, connecting, and sending things to the socket
